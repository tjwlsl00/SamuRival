...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField] GameObject PauseKeyPanel;
    ...
    private void UnvisibleUI()
    {
        ...
        // PauseKeyPanel.gameObject.SetActive(false);
        // 설명 패널 비활성화
    ...
    void ToggleMenuPanel()
    {
        if (MenuPanel != null)
        {
            ...
            {
                Debug.LogWarning("MouseEvent Instance 없음");
            }
        }
    }
    #endregion
