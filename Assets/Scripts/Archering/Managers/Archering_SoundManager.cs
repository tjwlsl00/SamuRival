...
public class Archering_SoundManager : MonoBehaviour
{
    ...
    [SerializeField] AudioClip decideTheWinnerClip;
    ...
    // 승자를 정할거야!
    public void PlayDecideTheWinnerClip()
    {
        if (decideTheWinnerClip != null)
        {
            audioSource.PlayOneShot(decideTheWinnerClip, 1f);
        }
    }
    #endregion
