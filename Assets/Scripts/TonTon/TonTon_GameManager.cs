...
public class TonTon_GameManager : MonoBehaviour
{
    ...
    private TonTon_SceneManger tonTon_SceneManger;
    ...
    void Awake()
    {
        ...
        tonTon_CameraManager =
        GetComponent<TonTon_CameraManager>();
        tonTon_SceneManger = GetComponent<TonTon_SceneManger>();
    ...
    void GameOver()
    {
        ...
        // 다음 씬 불러오기 
        StartCoroutine(tonTon_SceneManger.MoveToScene());
    }
    #endregion
}
