...
public class SpawnManager : MonoBehaviour
{
    ...
    [SerializeField] GameObject lastSpurtRedStone;
    [SerializeField] GameObject lastSpurtBlueStone;
    ...
    public void SetUpLastSpurtStone(int playerNum)
    {
        GameObject targetLastSpurtStone = (playerNum == 0) ? lastSpurtRedStone : lastSpurtBlueStone;

        if (targetLastSpurtStone != null)
        {
            GameObject spawnedStone = Instantiate(targetLastSpurtStone, stoneSpawnPoint.position, stoneSpawnPoint.rotation);
