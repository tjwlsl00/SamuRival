...
public class PlayerAudio : MonoBehaviour
{
    ...
    [SerializeField] AudioClip WearSnowHeadClip;
    [SerializeField] AudioClip SucessAttackClip;
    ...
    public void PlayWearSnowHead()
    {
        audioSource.clip = WearSnowHeadClip;
        audioSource.Play();
    }

    public void PlaySuccessAttack()
    {
        audioSource.clip = SucessAttackClip;
        audioSource.Play();
    }
